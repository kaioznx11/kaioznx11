...
**`Cyber Security Student`**
 ...
 Cybersecurity Student | Red Team & Pentesting Enthusiast
Learning Cyber Security with a focus on Red Team operations and Penetration Testing.
Experienced with C and C++, currently using Python for automation, scripting, and security tools.
...
![Parrot OS](https://img.shields.io/badge/Parrot%20OS-000000?style=for-the-badge&logo=parrot-security&logoColor=00E5FF)
